...
tab  = [[[0] for i in range(5)] for i in range(len(allWords))]
tab2 = [[[0] for j in range(5)] for j in range(len(allWords))]
tab3 = [[[0] for j in range(5)] for j in range(len(allWords))]
